...
(defpackage "GITHACK-TEST"
  ...
  (:import-from "GITHACK"
                ...
                "%ENSURE-PERSISTENT-WTTREE-NODE-LOADED!"
                ...
                "QUERY-MIN"
                "QUERY-GROUP-BY"
                "QUERY-DEFAULT-LESS-THAN"
                "QUERY-PARSE-CLAUSES"
                "%PUBLISH-LOADED!"
                "%CAS-INSTALL-ONCE!"
                "WITH-OBJECT-LOAD-LOCK"
                "%LOAD-STRIPE-MUTEX"
                "+LOAD-STRIPE-MUTEXES+"
                ...
                "LEDGER-TX-ID-FROM-REF"
                "PREPARE-TX-ID-FROM-REF"
                "TX-IDS-WITH-LEDGER-REFS"
                "TX-IDS-WITH-STRANDED-PREPARE-REFS"
                "SWEEP-STRANDED-PREPARE-REFS!"
                "RECONCILE-LEDGER-REFS!"
                "REPACK-REPOSITORY!")
